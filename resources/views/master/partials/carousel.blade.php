...
<div id="maincarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="carousel-item active">
            <img class="d-block img-fluid imgcustom" src="img/Slider/Slide%201.jpg" alt="Old Barn">
        ...
        <div class="carousel-item">
            <img class="d-block img-fluid imgcustom" src="img/Slider/Slide%202.jpg" alt="Pictured Rock - Lovers Leap">
            <div class="carousel-caption slidecap">
        ...
        <div class="carousel-item">
            <img class="d-block img-fluid imgcustom" src="img/Slider/Slide%203.jpg" alt="MAcro Buds">
            <div class="carousel-caption slidecap">
